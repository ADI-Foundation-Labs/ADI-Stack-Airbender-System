...
pub fn decode(opcode: u32) -> Instruction {
    ...
    let instruction = match op {
        ...
        OPCODE_BRANCH => {
            ...
            let isntr = match funct3 {
                0 => Instruction::from_imm(InstructionName::Beq, formal_rs1, formal_rs2, rd, imm),
                1 => Instruction::from_imm(InstructionName::Bne, formal_rs1, formal_rs2, rd, imm),
                4 => Instruction::from_imm(InstructionName::Blt, formal_rs1, formal_rs2, rd, imm),
                5 => Instruction::from_imm(InstructionName::Bge, formal_rs1, formal_rs2, rd, imm),
                6 => Instruction::from_imm(InstructionName::Bltu, formal_rs1, formal_rs2, rd, imm),
                7 => Instruction::from_imm(InstructionName::Bgeu, formal_rs1, formal_rs2, rd, imm),
                _ => {
        ...
        OP_IMM_SUBMASK => {
            ...
            let instr = match funct3 {
                ...
                GROUP_IMM_SLL if funct7 == SLL_FUNCT7 => {
                    ...
                    Instruction::from_imm(InstructionName::Slli, formal_rs1, formal_rs2, rd, imm & 0x1f)
                }
                GROUP_IMM_SRL if funct7 == SRL_FUNCT7 => {
                    // Shift is encoded in the lowest 5 bits
                    Instruction::from_imm(InstructionName::Srli, formal_rs1, formal_rs2, rd, imm & 0x1f)
                }
                GROUP_IMM_SRA if funct7 == SRA_FUNCT7 => {
                    // Shift is encoded in the lowest 5 bits
                    Instruction::from_imm(InstructionName::Srai, formal_rs1, formal_rs2, rd, imm & 0x1f)
                }
        ...
        OP_SUBMASK => {
            if funct7 == M_EXT_FUNCT7 {
                ...
                match funct3 {
                    0b000 => {
                        Instruction::from_imm(InstructionName::Mul, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b001 => {
                        Instruction::from_imm(InstructionName::Mulh, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b010 => {
                        Instruction::from_imm(InstructionName::Mulhsu, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b011 => {
                        Instruction::from_imm(InstructionName::Mulhu, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b100 => {
                        Instruction::from_imm(InstructionName::Div, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b101 => {
                        Instruction::from_imm(InstructionName::Divu, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b110 => {
                        Instruction::from_imm(InstructionName::Rem, formal_rs1, formal_rs2, rd, 0)
                    }
                    0b111 => {
                        Instruction::from_imm(InstructionName::Remu, formal_rs1, formal_rs2, rd, 0)
                    }
        ...
        OPCODE_LOAD => {
            ...
            match funct3 {
                a @ 0 | a @ 1 | a @ 2 | a @ 4 | a @ 5 => {
                    let instr = match a {
                        0 => {
                            Instruction::from_imm(InstructionName::Lb, formal_rs1, formal_rs2, rd, imm)
                        }
                        1 => {
                            Instruction::from_imm(InstructionName::Lh, formal_rs1, formal_rs2, rd, imm)
                        }
                        2 => {
                            Instruction::from_imm(InstructionName::Lw, formal_rs1, formal_rs2, rd, imm)
                        }
                        4 => {
                            Instruction::from_imm(InstructionName::Lbu, formal_rs1, formal_rs2, rd, imm)
                        }
                        5 => {
                            Instruction::from_imm(InstructionName::Lhu, formal_rs1, formal_rs2, rd, imm)
                        }
                        _ => unreachable!(),
                    };
            ...
            match funct3 {
                a @ 0 | a @ 1 | a @ 2 => {
                    let store_length = 1 << a;
                        ...
                        match store_length {
                            1 => {
                                Instruction::from_imm(InstructionName::Sb, formal_rs1, formal_rs2, rd, imm)
                            }
                            2 => {
                                Instruction::from_imm(InstructionName::Sh, formal_rs1, formal_rs2, rd, imm)
                            }
                            4 => {
                                Instruction::from_imm(InstructionName::Sw, formal_rs1, formal_rs2, rd, imm)
                            }
        ...
        OPCODE_SYSTEM => {
            ...
            let instr = if funct3 == ZIMOP_FUNCT3 {
                ...
                if funct7 & MOP_FUNCT7_TEST == MOP_FUNCT7_TEST {
                    ...
                    match mop_number {
                        0 => Instruction::from_imm(InstructionName::ZimopAdd, formal_rs1, formal_rs2, rd, 0),
                        1 => Instruction::from_imm(InstructionName::ZimopSub, formal_rs1, formal_rs2, rd, 0),
                        2 => Instruction::from_imm(InstructionName::ZimopMul, formal_rs1, formal_rs2, rd, 0),
                        _ => {
                ...
                let instr = match csr_number {
                    common_constants::NON_DETERMINISM_CSR => {
                        Instruction::from_imm(InstructionName::ZicsrNonDeterminism, formal_rs1, formal_rs2, rd, 0)
                    }
                    common_constants::BLAKE2S_DELEGATION_CSR_REGISTER => {
                        Instruction::from_imm(InstructionName::ZicsrDelegation, formal_rs1, formal_rs2, rd, DelegationType::Blake as u32)
                    }
                    common_constants::BIGINT_OPS_WITH_CONTROL_CSR_REGISTER => {
                        Instruction::from_imm(InstructionName::ZicsrDelegation, formal_rs1, formal_rs2, rd, DelegationType::BigInt as u32)
                    }
                    common_constants::KECCAK_SPECIAL5_CSR_REGISTER => {
                        Instruction::from_imm(InstructionName::ZicsrDelegation, formal_rs1, formal_rs2, rd, DelegationType::Keccak as u32)
                    }
                    _ => {
