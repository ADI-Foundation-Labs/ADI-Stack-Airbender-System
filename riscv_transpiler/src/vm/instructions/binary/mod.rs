...
#[inline(always)]
pub(crate) fn and<S: Snapshotter, R: RAM, const USE_IMM: bool>(
...
#[inline(always)]
pub(crate) fn or<S: Snapshotter, R: RAM, const USE_IMM: bool>(
    state: &mut State<S::Counters>,
    ram: &mut R,
    snapshotter: &mut S,
    instr: Instruction,
...
#[inline(always)]
pub(crate) fn xor<S: Snapshotter, R: RAM, const USE_IMM: bool>(
    state: &mut State<S::Counters>,
    ram: &mut R,
    snapshotter: &mut S,
    instr: Instruction,
