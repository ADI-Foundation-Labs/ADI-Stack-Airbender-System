    ...
    unsafe {
        worker.scope(cycles, |scope, geometry| {
            let mut range_16_multiplicity_subcounters_chunks =
                range_16_multiplicity_subcounters.as_chunks_mut::<1>().0.into_iter();
            let mut timestamp_range_check_multiplicity_subcounters_chunks =
                timestamp_range_check_multiplicity_subcounters.as_chunks_mut::<1>().0.into_iter();
            let mut general_purpose_multiplicity_subcounters_chunks =
                general_purpose_multiplicity_subcounters.as_chunks_mut::<1>().0.into_iter();
