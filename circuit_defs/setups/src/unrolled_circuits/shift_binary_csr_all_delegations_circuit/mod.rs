...
>(
    ...
    let circuit = ::shift_binary_csr_all_delegations::get_circuit_for_rom_bound::<
        { ::shift_binary_csr_all_delegations::ROM_ADDRESS_SPACE_SECOND_WORD_BITS },
    >(binary_image);
    let table_driver = ::shift_binary_csr_all_delegations::get_table_driver(binary_image);
    let (decoder_table_data, witness_gen_data) =
        ::shift_binary_csr_all_delegations::get_decoder_table::<B>(bytecode);
    ...
    let setup =
        SetupPrecomputations::<DEFAULT_TRACE_PADDING_MULTIPLE, A, DefaultTreeConstructor>::from_tables_and_trace_len_with_decoder_table(
            ...
            &lde_precomputations,
            ::shift_binary_csr_all_delegations::LDE_FACTOR,
            ::shift_binary_csr_all_delegations::TREE_CAP_SIZE,
            &worker,
        );

    #[cfg(feature = "witness_eval_fn")]
    let witness_eval_fn = Some(UnrolledCircuitWitnessEvalFn::NonMemory {
        witness_fn: ::shift_binary_csr_all_delegations::witness_eval_fn_for_gpu_tracer,
    ...
    UnrolledCircuitPrecomputations {
        family_idx: ::shift_binary_csr_all_delegations::FAMILY_IDX,
        trace_len: ::shift_binary_csr_all_delegations::DOMAIN_SIZE,
        lde_factor: ::shift_binary_csr_all_delegations::LDE_FACTOR,
        tree_cap_size: ::shift_binary_csr_all_delegations::TREE_CAP_SIZE,
